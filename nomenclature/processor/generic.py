...
class AggregationMapping(BaseModel):
    ...
    @classmethod
    def from_yaml(cls, file: Path | str):
        ...
        ----------
        file : Path | str
            Path to a yaml file which contains an aggregation mapping.
        ...
        return cls(mapping=mapping_list, file=get_relative_path(file))  # type: ignore
...
class Aggregator(Processor):
    ...
    def apply(self, df: IamDataFrame) -> IamDataFrame:
        ...
        """
        return df.rename(
            {self.dimension: self.mapping.rename_mapping},
